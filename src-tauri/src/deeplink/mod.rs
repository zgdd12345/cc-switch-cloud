//! Deep link import functionality for AgentHub
//!
//! This module implements the agenthub:// protocol for importing configurations
...
///
/// Represents a parsed agenthub:// URL ready for processing.
