...
//!
//! Parses agenthub:// URLs into DeepLinkImportRequest structures.
...
/// Parse a agenthub:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// agenthub://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "agenthub" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'agenthub', got '{scheme}'"
        )));
    }
