...
/// 将 `/path/to/AgentHub.app/Contents/MacOS/AgentHub` 转换为 `/path/to/AgentHub.app`
#[cfg(target_os = "macos")]
...
mod tests {
    ...
    fn test_get_macos_app_bundle_path_valid() {
        let exe_path = std::path::Path::new("/Applications/AgentHub.app/Contents/MacOS/AgentHub");
        let result = get_macos_app_bundle_path(exe_path);
        assert_eq!(
            result,
            Some(std::path::PathBuf::from("/Applications/AgentHub.app"))
        );
    }
    ...
    fn test_get_macos_app_bundle_path_with_spaces() {
        let exe_path =
            std::path::Path::new("/Users/test/My Apps/AgentHub.app/Contents/MacOS/AgentHub");
        let result = get_macos_app_bundle_path(exe_path);
        assert_eq!(
            result,
